...
class TestSyncGet:
    ...
    def test_get_repo_returns_bytes(self, pds_module):
        alice = pds_module.create_account("sync-get-repo.test")
        result = pds_module.sync_get(
    ...
    def test_unknown_method_raises(self, pds_module):
        with pytest.raises(XrpcError):
            pds_module.sync_get("com.atproto.sync.nonExistent")
...
class TestExportRepo:
    ...
    def test_returns_bytes(self, pds_module):
        alice = pds_module.create_account("sync-exp-bytes.test")
        car_bytes = alice.export_repo()
        assert isinstance(car_bytes, bytes)
        assert len(car_bytes) > 0

    def test_car_bytes_grow_with_records(self, pds_module):
        alice = pds_module.create_account("sync-exp-grow.test")
    ...
    def test_parseable_as_car(self, pds_module):
        alice = pds_module.create_account("sync-exp-parse.test")
    ...
    def test_car_contains_blocks_for_records(self, pds_module):
        alice = pds_module.create_account("sync-exp-blocks.test")
...
class TestGetBlob:
    ...
    def test_round_trip_blob(self, pds_module):
        alice = pds_module.create_account("sync-blob-rt.test")
    ...
    def test_different_blobs_have_different_cids(self, pds_module):
        alice = pds_module.create_account("sync-blob-diff.test")
...
class TestCrossAccountIsolation:
    ...
    def test_separate_repos(self, pds_module):
        alice = pds_module.create_account("sync-iso-a.test")
        bob = pds_module.create_account("sync-iso-b.test")
